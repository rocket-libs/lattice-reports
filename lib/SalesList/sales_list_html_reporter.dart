  ...
  Future<String> getHtml(
    ...
    cssBuilder
        ...
        .addToClass(".reportTitle",
            "font-weight: bold; font-size: 25px; color: $primaryColor; text-align:left; margin-bottom: 20px;")
        .addToClass(
    ...
    htmlBuilder
        ...
        .addLine(
            "Generated by <a href='${applicationInformation.downloadUrl}'>${applicationInformation.applicationName}</a> on ${DateTime.now().toDDDashMMMDashYYYYHHMM()}")
